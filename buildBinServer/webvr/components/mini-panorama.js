   ...
   setupDialog: function() {
    ...
    toggleDialogOpen: function() {
     ...
     if (this.data.active && this.dialogPlaneEl) {
       ...
       if (this.isOpen) {
            this.closeIconEl.classList.add(this.data.aclass);
            this.rightIconEl.classList.add(this.data.aclass);
            this.leftIconEl.classList.add(this.data.aclass);
       } else {
            this.closeIconEl.classList.remove(this.data.aclass);
            this.rightIconEl.classList.remove(this.data.aclass);
            this.leftIconEl.classList.remove(this.data.aclass);
       }
     ...
     generateDialogPlane: function generateDialogPlane() {
       var _this$data6 = this.data,
         ...
         if (this.dialogPlaneEl) {
            while (this.dialogPlaneEl.firstChild) {
                this.dialogPlaneEl.removeChild(this.dialogPlaneEl.firstChild);
            }
         } else {
            this.dialogPlaneEl = document.createElement('a-entity');
         }


       var plane = this.dialogPlaneEl
    ...
    generateRightArrow: function generateRightArrow() {
     ...
     generateOverlay: function generateOverlay() {
         ...
         overlay.setAttribute('position', '0 0 -8.1');
